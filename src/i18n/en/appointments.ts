export default {
  appointment: {
    ...
    no_appointments_found: "No appointments to show",
    viewing_appointment_for: "Viewing appointments for",
    ...
    view_details_title: "Appointment Details",
    ...
    // Status Badges
    status: {
      upcoming: "Upcoming", // Matches 'apcomming' & 'apcomang' in PDF [cite: 47]
      completed: "Completed",
      cancelled: "Cancelled",
    },
  },
